...
from pennylane.kernels import cost_functions
...
def optimize_circuit(params,hamiltonian):
    ...
    cost_funct=lambda params: circuit(params,hamiltonian)
    # Write your code to minimize the circuit
    opt = qml.GradientDescentOptimizer(0.5)
    max_iterations = 25
    param_opt=params
    for i in range(max_iterations):
        param_opt=opt.step(cost_funct,param_opt)
    return circuit(param_opt,hamiltonian)# Return the value of the minimized QNode
