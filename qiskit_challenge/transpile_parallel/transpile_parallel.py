...
transpiler_services = [
        {'service': TranspilerService(backend_name=backend_name, ai=False, optimization_level=3), 'ai': False, 'optimization_level': 3},
        {'service': TranspilerService(backend_name=backend_name, ai=True, optimization_level=3), 'ai': True, 'optimization_level': 3}
    ]
